...
public interface CodeMaster {
	...
	public static final int SUCCESS = 1101; // Exception
	...
	public static final String AREAHEAD = "AREAHEAD";
	...
	public static final String EDIBLE_OILS = "C101";
	public static final String READY_TO_COOK = "C102";
	public static final String READY_TO_EAT_SNACKS = "C103";
	public static final String SPREADS = "C104";
	public static final String CEREAL_SNACKS = "C105";
	public static final String CHOCOLATEY_CONFECTIONERY = "C106";
