...
public class SecurityTokenConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable()
				...
				.antMatchers("/master" + "/dashboard" + "/statusWiseOrdersCount/**").hasAnyRole( "DISTRIBUTOR", "ADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/dashboard" + "/categoryRevenueDistribution/**").hasAnyRole( "DISTRIBUTOR", "ADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/dashboard" + "/dailySales/**").hasAnyRole( "DISTRIBUTOR", "ADMIN","SALES","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/dashboard" + "/monthlySales/**").hasAnyRole( "DISTRIBUTOR", "ADMIN","SALES","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/dashboard" + "/dailySalesExcel/**").hasAnyRole( "DISTRIBUTOR", "ADMIN","SALES","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				...
				.antMatchers("/master" + "/categories" + "/findCategoryBy/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/categories" +"/findCategoryByStatus/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/categories" +"/searchCategory/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/subCategories" + "/findSubCategoryByorgId/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				.antMatchers("/master" + "/subCategories" + "/findSubCategorybyStatus/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD","ORGANIZATION_USER")
				...
				/* //------Cart---- */
				 ...
				 .antMatchers("/cart" + "/ltsalesreturn" + "/getSalesReturn/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				 .antMatchers("/cart" + "/ltsalesreturn" + "/getInvoices/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
