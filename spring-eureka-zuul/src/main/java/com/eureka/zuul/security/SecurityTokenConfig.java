...
public class SecurityTokenConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable()
				...
				.antMatchers("/uam" + "/outlets" + "/getById/**").hasAnyRole("PREVERIFIED", "RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				.antMatchers("/uam" + "/outlets" + "/update/**").hasAnyRole("PREVERIFIED", "RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				.antMatchers("/uam" + "/outlets" + "/verifyOutlet/**").hasAnyRole("PREVERIFIED","RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				//.antMatchers("/uam" + "/outlets" + "/confirmOutletVarify/**").hasAnyRole("PREVERIFIED", "RETAILER", "ADMIN", "SUPERADMIN")
				.antMatchers("/uam" + "/outlets" + "/outletSearchByStore/**").hasAnyRole("DISTRIBUTOR", "RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				.antMatchers("/uam" + "/outlets" + "/searchAllOutlet/**").hasAnyRole("DISTRIBUTOR", "RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				.antMatchers("/uam" + "/outlets" + "/allOutletSearch/**").hasAnyRole("DISTRIBUTOR", "RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				.antMatchers("/uam" + "/outlets" + "/searchOutletByStoreName/**").hasAnyRole("DISTRIBUTOR", "RETAILER", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				...
				.antMatchers("/uam" + "/users" + "/setSelectedOutlet/**").hasAnyRole("DISTRIBUTOR", "RETAILER","SALES", "ADMIN", "SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				...
				.antMatchers("/uam" + "/org" + "/verifyOrganisation/**").hasAnyRole("PREVERIFIED",  "ADMIN", "SUPERADMIN", "ORGANIZATION_USER", "SYSTEMADMINISTRATOR", "SALESOFFICER")
				...
				.antMatchers("/uam" + "/users" + "/getUserById/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				
				
				.antMatchers("/uam" + "/users" + "/savePersonalDetails/**").hasAnyRole( "PREVERIFIED","DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER")
				...
				.antMatchers("/uam" + "/users" + "/saveAddress/**").hasAnyRole("PREVERIFIED","DISTRIBUTOR","ADMIN","SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "ORGANIZATION_USER" )
				...
				.antMatchers("/uam" + "/promotion" + "/editPromotion/**").hasAnyRole( "DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD")
				 ...
				 .antMatchers("/uam" + "/outlets" + "/getAllUserMastData/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SUPERADMIN","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				 .antMatchers("/uam" + "/outlets" + "/getAllOutletType/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SUPERADMIN","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD","SALES", "SYSTEMADMINISTRATOR")
				 ...
				 .antMatchers("/uam" + "/users" + "/getUsersList/**").hasAnyRole("PREVERIFIED","DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				...
				/* //------Cart---- */
				 ...
				 .antMatchers("/uam" + "/outlets" + "/getBeatDetailsAgainsDistirbutorCodeAndBeatName/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				 .antMatchers("/uam" + "/outlets" + "/updateBeatSequence/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				 ...
				 .antMatchers("/uam" + "/outlets" + "/getBeatDetailsAgainsDistirbutorCode/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				 .antMatchers("/uam" + "/outlets" + "/getOutletAgainstBeat/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD", "SYSTEMADMINISTRATOR")
				 
				 .antMatchers("/uam" + "/distributor" + "/getAllNotification/**").hasAnyRole("DISTRIBUTOR", "ADMIN", "SALES","RETAILER","SUPERADMIN","SALESOFFICER","AREAHEAD")
