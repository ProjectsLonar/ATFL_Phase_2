...
public class LtOutletDto {
	...
	public String toString() {
		return "LtOutletDto [outletId=" + outletId + ", distributorId=" + distributorId + ", outletCode=" + outletCode
				...
				+ ", address1=" + address1 + ", position=" + position + ", outletChannel=" + outletChannel
