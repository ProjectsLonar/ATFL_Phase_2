...
import com.users.usersmanagement.service.LtMastSmsTokenService;
...
public class LtMastSmsTokenController {
	...
	public ResponseEntity<Status> sendSms(@PathVariable("transId") String transId) throws ServiceException, ParseException, JsonParseException, JsonMappingException, IOException, InterruptedException
	{
		try {
