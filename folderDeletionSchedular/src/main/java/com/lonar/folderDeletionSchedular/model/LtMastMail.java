...
public class LtMastMail {
	...
	public String toString() {
		return "LtMastEmailToken [emailTokenId=" + emailTokenId + ", orgId=" + orgId + ", transactionId="
				+ transactionId + ", orderNumber=" + orderNumber + ", sendDate=" + sendDate + ", expiredWithin="
				+ expiredWithin + ", emailTemplate=" + emailTemplate + ", emailStatus=" + emailStatus + ", emailBody="
				+ emailBody + ", emailSubject=" + emailSubject + ", sendTo=" + sendTo + ", sendCc=" + sendCc
				+ ", attachmentPath=" + attachmentPath + ", failureCount=" + failureCount + "]";
	}
